...
for model_set in ['resnet50', 'resnet18']:
    if model_set == 'resnet50':
        weight_set = 'ResNet50_Weights.IMAGENET1K_V2'
    else:
        weight_set = 'ResNet18_Weights.IMAGENET1K_V1'
    # model_rn = models.model_set(weights=models.weight_set)
    model_rn = getattr(models, model_set)(pretrained=True)
